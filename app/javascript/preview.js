document.addEventListener('DOMContentLoaded', function(){
  ...
  const buildNewFileField = () => {
    ...
    newFileField.setAttribute('image_name', 'post[images][]');

    // 最後のfile_fieldを取得
    const lastFileField = document.querySelector('input[type="file"][image_name="post[images][]"]:last-child');
  ...
  // input要素を取得
  const fileField = document.querySelector('input[type="file"][image_name="post[images][]"]');
